    ...
    private void loadResidentDetail(int residentId, String memberRole) {
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                ((TextView) findViewById(R.id.tvResidentId)).setText(safeText(resident.residentCode));
                ...
                ((TextView) findViewById(R.id.tvDocumentType)).setText(safeText(resident.idType));
