...
public class DatabaseInitializer {
    ...
    private static void insertCoreSampleData(AppDatabase db) {
        new Thread(() -> {
            ...
            db.runInTransaction(() -> {
                ...
                r1.fullName = "Nguyễn Văn Minh"; r1.phone = "0901234567"; r1.email = "minh.nguyen@gmail.com";
                r1.dob = "15/03/1980"; r1.gender = "Nam"; r1.idNum = "079180012345"; r1.avatarUrl = "";

                Resident r2 = new Resident();
                r2.fullName = "Trần Thị Lan"; r2.phone = "0901234568"; r2.email = "lan.tran@gmail.com";
                r2.dob = "22/07/1983"; r2.gender = "Nữ"; r2.idNum = "079183045678"; r2.avatarUrl = "";

                Resident r3 = new Resident();
                r3.fullName = "Nguyễn Minh Khoa"; r3.phone = "0901234569"; r3.email = "khoa.nguyen@gmail.com";
                r3.dob = "10/09/2008"; r3.gender = "Nam"; r3.idNum = ""; r3.avatarUrl = "";

                // Căn hộ P.0802 (id=2)
                Resident r4 = new Resident();
                r4.fullName = "Phạm Thị Hoa"; r4.phone = "0912345678"; r4.email = "hoa.pham@gmail.com";
                r4.dob = "05/11/1975"; r4.gender = "Nữ"; r4.idNum = "079175067890"; r4.avatarUrl = "";

                Resident r5 = new Resident();
                r5.fullName = "Lê Quang Hùng"; r5.phone = "0912345679"; r5.email = "hung.le@gmail.com";
                r5.dob = "18/06/1973"; r5.gender = "Nam"; r5.idNum = "079173023456"; r5.avatarUrl = "";

                // Căn hộ P.0305 (id=3)
                Resident r6 = new Resident();
                r6.fullName = "Vũ Đức Thành"; r6.phone = "0987654321"; r6.email = "thanh.vu@gmail.com";
                r6.dob = "30/01/1988"; r6.gender = "Nam"; r6.idNum = "079188034567"; r6.avatarUrl = "";

                Resident r7 = new Resident();
                r7.fullName = "Ngô Thị Bích Ngọc"; r7.phone = "0987654322"; r7.email = "ngoc.ngo@gmail.com";
                r7.dob = "14/04/1990"; r7.gender = "Nữ"; r7.idNum = "079190056789"; r7.avatarUrl = "";

                // Căn hộ P.0506 (id=4)
                Resident r8 = new Resident();
                r8.fullName = "Đinh Công Toàn"; r8.phone = "0933445566"; r8.email = "toan.dinh@gmail.com";
                r8.dob = "25/12/1985"; r8.gender = "Nam"; r8.idNum = "079185078901"; r8.avatarUrl = "";
                
                // Căn hộ P.0712 (id=5)
                Resident r9 = new Resident();
                r9.fullName = "Lý Hải Yến"; r9.phone = "0909001122"; r9.email = "yen.ly@gmail.com";
                r9.dob = "12/05/1992"; r9.gender = "Nữ"; r9.idNum = "079192011223"; r9.avatarUrl = "";

                // Căn hộ P.1105 (id=6)
                Resident r10 = new Resident();
                r10.fullName = "Hoàng Tuấn Anh"; r10.phone = "0988776655"; r10.email = "anh.hoang@gmail.com";
                r10.dob = "03/08/1982"; r10.gender = "Nam"; r10.idNum = "079182044556"; r10.avatarUrl = "";
                
                Resident r11 = new Resident();
                r11.fullName = "Trương Mỹ Linh"; r11.phone = "0988776656"; r11.email = "linh.truong@gmail.com";
                r11.dob = "19/11/1985"; r11.gender = "Nữ"; r11.idNum = "079185077889"; r11.avatarUrl = "";

                // Căn hộ P.0201 (id=7)
                Resident r12 = new Resident();
                r12.fullName = "Phan Đình Phùng"; r12.phone = "0911223344"; r12.email = "phung.phan@gmail.com";
                r12.dob = "28/02/1970"; r12.gender = "Nam"; r12.idNum = "079170099001"; r12.avatarUrl = "";

                // Căn hộ P.0404 (id=8)
                Resident r13 = new Resident();
                r13.fullName = "Bùi Thị Mai"; r13.phone = "0966554433"; r13.email = "mai.bui@gmail.com";
                r13.dob = "09/09/1995"; r13.gender = "Nữ"; r13.idNum = "079195022334"; r13.avatarUrl = "";
                ...
                r1.accountId = accounts.get(0).id; db.residentDao().update(r1);
                r4.accountId = accounts.get(1).id; db.residentDao().update(r4);
                r6.accountId = accounts.get(2).id; db.residentDao().update(r6);
                r8.accountId = accounts.get(3).id; db.residentDao().update(r8);
                r9.accountId = accounts.get(4).id; db.residentDao().update(r9);
                r10.accountId = accounts.get(5).id; db.residentDao().update(r10);
                r12.accountId = accounts.get(6).id; db.residentDao().update(r12);
                r13.accountId = accounts.get(7).id; db.residentDao().update(r13);
    ...
    private static Apartment createApt(int accId, String aptCode, String bCode, int floor, float area, String status) {
        ...
        a.accountId = accId; a.apartmentCode = aptCode; a.buildingCode = bCode;
        a.floor = floor; a.area = area; a.status = status;
        return a;
    }
    ...
    private static ApartmentMember createMember(int aptId, int resId, String role, String type) {
        ...
        m.apartmentId = aptId; m.residentId = resId; m.role = role; m.residentType = type;
        return m;
    }
    ...
    private static void insertSampleVehicles(AppDatabase db) {
        new Thread(() -> {
            if (!db.vehicleDao().getVehiclesByResidentIdsSync(Arrays.asList(1, 2, 3)).isEmpty()) return;
            ...
            for (Vehicle v : vh) db.vehicleDao().insertVehicle(v);
        }).start();
    }
    
    private static Vehicle createVehicle(int aptId, int resId, String type, String brand, String color, String plate, String status) {
        Vehicle v = new Vehicle();
        v.apartmentId = aptId; v.residentId = resId; v.vehicleType = type;
        v.brand = brand; v.color = color; v.licensePlate = plate; v.status = status;
        return v;
    }
    ...
    private static void insertSampleInvoices(AppDatabase db) {
        new Thread(() -> {
            if (!db.paymentDao().getAllInvoices().isEmpty()) return;

            // ── CĂN HỘ 1 (P.1205) ────────────────────────────────────────────────
            insertInvoiceFull(db, "INV-032026-1205", "1", "03/2026", 2370700, "15/04/2026", "UNPAID",
                1430, 1580, 142, 157, 1, 1000000, "01 Ô tô, 02 Xe máy", "Gói Tốc độ cao – 150 Mbps", 450000, null, null);
            insertInvoiceFull(db, "INV-022026-1205", "1", "02/2026", 2195000, "15/03/2026", "PAID",
                1290, 1430, 128, 142, 1, 1000000, "01 Ô tô, 02 Xe máy", "Gói Tốc độ cao – 150 Mbps", 450000, "#TXN0226-88A1", "10/03/2026 - 09:42");
            insertInvoiceFull(db, "INV-012026-1205", "1", "01/2026", 2087500, "15/02/2026", "PAID",
                1165, 1290, 115, 128, 1, 1000000, "01 Ô tô, 02 Xe máy", "Gói Tốc độ cao – 150 Mbps", 450000, "#TXN0126-77B2", "12/02/2026 - 14:20");
            insertInvoiceFull(db, "INV-122025-1205", "1", "12/2025", 2320000, "15/01/2026", "PAID",
                1010, 1165, 100, 115, 1, 1000000, "01 Ô tô, 02 Xe máy", "Gói Tốc độ cao – 150 Mbps", 450000, "#TXN1225-66C3", "08/01/2026 - 10:05");
            insertInvoiceFull(db, "INV-112025-1205", "1", "11/2025", 2150000, "15/12/2025", "PAID",
                880, 1010, 90, 100, 1, 1000000, "01 Ô tô, 02 Xe máy", "Gói Tốc độ cao – 150 Mbps", 450000, "#TXN1125-99D4", "10/12/2025 - 08:30");
            ...
            insertInvoiceFull(db, "INV-022026-0802", "2", "02/2026", 1790000, "15/03/2026", "PAID",
                390, 500, 32, 40, 1, 850000, "01 Ô tô, 02 Xe máy", "Gói Cơ bản – 80 Mbps", 250000, "#TXN0226-11A2", "12/03/2026 - 19:15");

            // ── CĂN HỘ 3 (P.0305) ────────────────────────────────────────────────
            insertInvoiceFull(db, "INV-032026-0305", "3", "03/2026", 2100000, "15/04/2026", "PAID",
                700, 850, 60, 75, 1, 850000, "01 Ô tô, 01 Xe máy", "Gói Tiêu chuẩn – 100 Mbps", 350000, "#TXN0326-55C5", "05/04/2026 - 11:20");
            ...
            insertInvoiceFull(db, "INV-022026-0712", "5", "02/2026", 920000, "15/03/2026", "PAID",
                210, 300, 18, 25, 1, 150000, "01 Xe máy", "Gói Cơ bản – 80 Mbps", 250000, "#TXN0226-44B4", "14/03/2026 - 20:00");
                
            // ── CĂN HỘ 6 (P.1105) ────────────────────────────────────────────────
            insertInvoiceFull(db, "INV-032026-1105", "6", "03/2026", 2550000, "15/04/2026", "UNPAID",
                800, 1000, 80, 100, 1, 850000, "01 Ô tô, 01 Xe máy", "Gói Doanh nghiệp – 300 Mbps", 600000, null, null);

        }).start();
    }
    
    private static void insertInvoiceFull(AppDatabase db, String invId, String aptId, String month, long total, String due, String status,
        ...
        elec.invoiceId = invId; elec.serviceType = "ELECTRIC";
        elec.oldIndex = elecOld; elec.newIndex = elecNew; elec.unitPrice = 3858;
        elec.amount = (elecNew - elecOld) * elec.unitPrice;
        items.add(elec);

        InvoiceItem water = new InvoiceItem();
        water.invoiceId = invId; water.serviceType = "WATER";
        water.oldIndex = waterOld; water.newIndex = waterNew; water.unitPrice = 22800;
        water.amount = (waterNew - waterOld) * water.unitPrice;
        items.add(water);

        InvoiceItem parking = new InvoiceItem();
        parking.invoiceId = invId; parking.serviceType = "PARKING";
        parking.quantity = parkQty; parking.unitPrice = parkAmount; parking.amount = parkAmount;
        parking.description = parkDesc;
        items.add(parking);

        InvoiceItem internet = new InvoiceItem();
        internet.invoiceId = invId; internet.serviceType = "INTERNET";
        internet.description = netDesc; internet.amount = netAmount;
        items.add(internet);
    ...
    private static void insertSampleGuestPasses(AppDatabase db) {
        new Thread(() -> {
            if (!db.guestPassDao().getGuestPassesByApartmentIdSync(1).isEmpty()) return;
    ...
    private static void insertSampleNotifications(AppDatabase db) {
        new Thread(() -> {
            if (!db.appNotificationDao().getAllNotifications().isEmpty()) return;

            AppNotification n1 = new AppNotification();
            n1.type = "MAINTENANCE"; n1.title = "Bảo trì định kỳ hệ thống thang máy tòa S1 & S2";
            n1.shortDescription = "Ban Quản lý thông báo lịch bảo trì thang máy ngày 05/04/2026. Trong thời gian bảo trì...";
            n1.dateStr = "01/04/2026"; n1.timeStr = "08:00 SA"; n1.isRead = false;
    ...
    private static void insertSampleFacilities(AppDatabase db) {
        new Thread(() -> {
            if (!db.facilityDao().getAllFacilities().isEmpty()) return;

            Facility f1 = new Facility();
            f1.name = "Sân cầu lông"; f1.location = "Tầng 3, Khu thể thao, Tòa S1";
            f1.imageResId = R.drawable.img_badminton_court; f1.capacity = 4;
            f1.openTime = "06:00"; f1.CloseTime = "22:00"; f1.isOpen = true;
            f1.description = "Sân cầu lông tiêu chuẩn với 2 làn thi đấu, sàn gỗ chống trơn...";

            Facility f2 = new Facility();
            f2.name = "Sân bóng đá mini"; f2.location = "Tầng 4, Khu thể thao, Tòa S1";
            f2.imageResId = R.drawable.img_football_field; f2.capacity = 10;
            f2.openTime = "06:00"; f2.CloseTime = "21:00"; f2.isOpen = true;
            f2.description = "Sân bóng đá mini 5 vs 5 với mặt cỏ nhân tạo thế hệ mới...";

            Facility f3 = new Facility();
            f3.name = "Sân bóng chuyền"; f3.location = "Ngoài trời, Khu vui chơi, Tòa S2";
            f3.imageResId = R.drawable.img_volleyball_court; f3.capacity = 12;
            f3.openTime = "06:00"; f3.CloseTime = "21:00"; f3.isOpen = true;
    ...
    private static void insertSampleFacilityBookings(AppDatabase db) {
        new Thread(() -> {
            if (!db.facilityBookingDao().getAdminFacilityBookings().isEmpty()) return;
            ...
            insertBooking(db, 1, 6, "20/03/2026", "22/03/2026", "14:00", "16:00", "CANCELLED", "Có việc đột xuất"); // Ông Thành
            insertBooking(db, 1, 9, "02/04/2026", "05/04/2026", "09:00", "11:00", "PENDING", null);  // Lý Hải Yến
            insertBooking(db, 1, 12, "25/03/2026", "27/03/2026", "16:00", "18:00", "COMPLETED", null); // Phan Đình Phùng
    ...
    private static void insertBooking(AppDatabase db, int facId, int resId, String bDate, String dDate, String start, String end, String status, String reason) {
        FacilityBooking b = new FacilityBooking();
        b.facilityId = facId; b.residentId = resId; b.bookingDate = bDate;
        b.DayBooking = dDate; b.startTime = start; b.endTime = end;
        b.status = status; b.cancelReason = reason;
